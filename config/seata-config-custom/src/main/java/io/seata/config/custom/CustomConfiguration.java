...
public class CustomConfiguration extends AbstractConfiguration {
    private static volatile CustomConfiguration instance;
    ...
    private static final String CONFIG_TYPE = "custom";
    ...
    private CustomConfiguration() {
        if (null == configService) {
            try {
                ...
                String test = configService.getConfig("example", SEATA_GROUP, 1000);
